...
while True:
    ...
    if df['previous_closest_centroid'].equals(df['closest_centroid']):
        for row in df.itertuples():
             final_SSE +=  min(float(euclidean_distance([row[1], row[2]], centroids[0])),     float(euclidean_distance([row[1], row[2]], centroids[1]))) ** 2

        print("Final SSE is " + str(final_SSE))
...
print("Printing Plot with Version 1 of Clustering with Starting Centroids (7,7) and (14,14)")
...
print("Printing Plot with Version 2 of Clustering with Starting Centroids (7,7) and (14,14)")
sns.scatterplot(x='Win_2015', y='Win_2017', data=df, palette=['blue','red'], hue="closest_centroid")
...
print("Printing Plot with Version 1 of Clustering with Starting Centroids (7,7) and (7,14)")
sns.scatterplot(x='Win_2015', y='Win_2017',  data=df, palette=['blue','red'], hue="closest_centroid")
...
print("Printing Plot with Version 2 of Clustering with Starting Centroids (7,7) and (7,14)")
sns.scatterplot(x='Win_2015', y='Win_2017',  data=df, palette=['blue','red'],                hue="closest_centroid")
